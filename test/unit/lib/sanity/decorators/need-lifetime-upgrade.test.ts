...
const lifetimeBase = { permissions: [LIFETIME, BASE], isAdmin: false, isModerator: false, isABasicMember: true, hasAllContentAccess: false }
const lifetimeBasePlus = { permissions: [LIFETIME, BASE, PLUS], isAdmin: false, isModerator: false, isABasicMember: false, hasAllContentAccess: false }
const baseOnly = { permissions: [BASE], isAdmin: false, isModerator: false, isABasicMember: true, hasAllContentAccess: false }
